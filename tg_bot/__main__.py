...
PM_START_TEXT = """
Hi {}, my name is {}! If you have any questions on how to use me, read /help - and then head to @officialwhatsnew.
...
Feel free to submit pull requests on github, or to contact my support group, @officialwhatsnew, with any bugs, questions \
or feature requests you might have :)
I also have a tech channel & group join for new custom ROMs, @whatsnew_official .
